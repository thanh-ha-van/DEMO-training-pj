...
public class CustomPlaybackControlView extends FrameLayout {
     ...
     * modification.
     */
    public static final CustomPlaybackControlView.ControlDispatcher DEFAULT_CONTROL_DISPATCHER = new CustomPlaybackControlView.ControlDispatcher() {
    ...
    private CustomPlaybackControlView.ControlDispatcher controlDispatcher;
